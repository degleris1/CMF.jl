function evaluate_mse(r::CNMF_results)
    return compute_loss(r.data, r.W, r.H)
end


function evaluate_test(r::CNMF_results, test::AbstractMatrix; num_iter=30)
...
function evaluate_convergence(r::CNMF_results; thresh=0.01)
